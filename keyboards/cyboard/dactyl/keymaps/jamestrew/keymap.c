...
enum custom_layers { _WORKMAN, _WASD, _SYM, _HJKL, _MEDIA };
...
[_HJKL] = LAYOUT_manuform_num(
  ...
  KC_PGDN , KC_HOME , _______ , KC_LEFT , KC_TAB  , _______ ,                                 _______ , _______  , _______ , _______ , KC_END  , _______,
...
tap_dance_action_t tap_dance_actions2[] = {
